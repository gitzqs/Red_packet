...
<title>支付测试</title>
<script type="text/javascript" src="${ctx}/js/pay/json2.js"></script>
<script type="text/javascript" src="${ctx}/js/pay/common.js"></script>
</head>
<body>
<div>
<form  id="form_query" method="post" action="http://localhost:8080/Pay_platform/orderCreate">
订单金额<input type="text" name="totalAmount" id="totalAmount" value="0.12" /><br/>
...
异步通知地址<input type="text" name="notifyUrl" id="notifyUrl" value="http://localhost:8080/sandpay-gateway-demo/notice" /><br/>
前台通知地址<input type="text" name="frontUrl" id="frontUrl" value="http://localhost:8080/sandpay-gateway-demo/frontNotice" /><br/>
